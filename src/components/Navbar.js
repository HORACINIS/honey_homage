                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            ...
                            <button style={{ marginLeft: '10px' }} type="button" className="btn btn-warning position-relative">
                                Shopping Cart <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-secondary">4<span className="visually-hidden">Items</span></span>
                            </button>
                        </li>
